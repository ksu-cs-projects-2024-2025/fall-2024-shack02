...
class GraphVisualizer:
    ...
    def base_visualizer(self, graph_data, config, artist=False, track=False, album=False, genre=False, track_features=False):
        ...
        for data in graph_data:
            ...
            if genre:
                ...
                net.add_node(genre_data["id"], label=genre_data["name"], title=genre_data["name"], group = 'Genre', physics=False)
            if track_features:
    ...
    def create_shortest_path_network(self, graph_data):
        ...
        html = net.generate_html("shortest_paht.html",notebook=False)
